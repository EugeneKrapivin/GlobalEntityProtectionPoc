...
namespace SiloA.Host
{
    public class Program
    {
        ...
        private const int PortBase = 50010;
            ...
            Microsoft.Extensions.Hosting.Host.CreateDefaultBuilder(args)
                .UseOrleans((ctx, siloBuilder) =>
                {
                    siloBuilder
                        ...
                        {
                            opt.TableName = "OrleansMembershipSysA";
                            opt.ConnectionString = ctx.Configuration["Storage:ConnectionString"];
                        })
                        .AddAzureTableGrainStorage("workspaces", opt =>
                        {
                            opt.ConnectionString = ctx.Configuration["Storage:ConnectionString"];
                            opt.TableName = "Workspaces";
                        ...
                        .AddKafka("stream-provider")
                            .WithOptions(options =>
                            {
                                ...
                                options.ConsumerGroupId = "system-a";
